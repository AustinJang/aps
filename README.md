...
R package for adversarial parameter selection in Monte Carlo simulation studies. Uses Bayesian optimization with deep ensembles to identify parameter configurations that expose worst-case method performance.
...
- `obj_function`: Function taking parameter vector, returning scalar performance
...
*This package was developed with the assistance of [Claude Code](https://claude.ai/claude-code). All remaining errors are my own.*
